...
parser.add_argument('-eA', '--export_all', dest='export_all_outfile', action='store_true', help='Export entire database to Excel with given filename', required=False)
parser.add_argument('-e', '--export', dest='export_outfile', action='store_true', help='Export current query response to Excel with given filename', required=False)
